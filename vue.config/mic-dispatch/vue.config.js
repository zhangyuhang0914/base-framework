...
// 生产环境根目录 -- 用于nginx上下文
const PROD_BASE_URL = '/micManage/'
const outputDir = 'mic-manage'
  ...
  devServer: {
    ...
    proxy: {
      ...
      '/ucc_server': {
        ...
        // target: 'http://172.16.80.92:8080/icp', // 黄映龙
        // target: 'http://172.16.4.32:8889/icp', // Jenkins-陈鹏
      ...
      '/fileServer': {
        target: 'http://172.16.4.226:8081/fileServer',
        changeOrigin: true,
        pathRewrite: {
          '^/fileServer': ''
        }
