  ...
  return (function (e) {
            ...
            typeof (n = function (e) {
              ...
              Object.defineProperty(e, '__esModule', { value: !0 }),
                ...
                (e.isPlainObject = function (e) {
                  ...
                  if (!e || t(e) !== 'object' || e.nodeType || u(e)) return !1
                  try {
                    if (
                      e.constructor &&
                ...
                return (
                  ...
                  (o = [
                    ...
                    },
                    {
                      key: 'trigger',
                      value: function (e, t) {
                        if (typeof this.eventList[e] === 'function')
                          this.eventList[e].call(this, t)
                        else {
                          var o = 'on' + e.charAt(0).toUpperCase() + e.slice(1)
                          typeof this[o] === 'function' && this[o].call(this, t)
                        }
                        return this
                      }
                    },
      ...
      function p(e, t) {
        ...
        if (e.insertAt === 'top')
          n
            ...
            d.push(t)
        else if (e.insertAt === 'bottom') o.appendChild(t)
        else {
        ...
        void 0 ===
          (i =
            typeof (n = function (o, n, r, i, a, l, c) {
              ...
              function f(e, t) {
                return !t || (d(t) !== 'object' && typeof t !== 'function')
                  ? (function (e) {
                      if (void 0 === e)
                ...
                m = (function (e) {
                  function t() {
                    ...
                    for (
                      ...
                      r[i] = arguments[i]
                    return (
                      (o = f(this, (e = v(t)).call.apply(e, [this].concat(r)))),
                      h.push(o.id),
                      (o.tplTabbox = ''),
                  ...
                  return (
                    ...
                    (i = [
                      ...
                      },
                      {
                        ...
                        value: function () {
                          ;(this.isShow = !0),
                            this.isInBottom == 1 && this.autoScrollToBottom()
                        }
                      },
                      {
                        key: 'onHide',
                      ...
                      },
                      {
                        key: 'printOriginLog',
                        value: function (e) {
                          typeof this.console[e.logType] === 'function' &&
                        ...
                        value: function (e, t) {
                          for (
                            var o = r.default.render(a.default, {
                              ...
                              i = r.default.one('.vc-item-content', o),
                              l = 0;
                            l < t.length;
                            l++
                          ) {
                            ...
                            try {
                              if (t[l] === '') continue
                              c = n.isFunction(t[l])
                                ? '<span> ' + t[l].toString() + '</span>'
                                : n.isObject(t[l]) || n.isArray(t[l])
                                ? this.getFoldedLine(t[l])
                                : '<span> ' +
                                  n.htmlEncode(t[l]).replace(/\n/g, '<br/>') +
                                  '</span>'
                            } catch (e) {
                              c = '<span> [' + d(t[l]) + ']</span>'
                            }
                          ...
                          n.isObject(e.content) &&
                            i.insertAdjacentElement('beforeend', e.content),
                            r.default
    ...
    function (module, exports, __webpack_require__) {
      ...
      ;(factory = function (
                                ...
                                ;(_$li.innerHTML = winKeys[_i4]),
                                  (_$li.onclick = function () {
                                    ;(_query.default.one(
                                      ...
                                      keyTypes[this.innerHTML] == 'function' &&
                                        (_query.default.one(
                                          '.vc-cmd-input'
                                        ).value += '()'),
                                      ($prompted.style.display = 'none')
        ...
        void 0 ===
          (__WEBPACK_AMD_DEFINE_RESULT__ =
            typeof (__WEBPACK_AMD_DEFINE_FACTORY__ = factory) === 'function'
                ...
                return (
                  ...
                  (i = [
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ;(this.isShow = !0),
                          this.isInBottom == 1 && this.scrollToBottom()
                      }
                    },
                    {
                      key: 'onHide',
                    ...
                    },
                    {
                      ...
                      value: function (e, t) {
                        ...
                        if (((this.reqList[e] = i), this.isReady)) {
                          ...
                          i.readyState == 0 || i.readyState == 1
                            ? (l.status = 'Pending')
                            : i.readyState == 2 || i.readyState == 3
                            ? (l.status = 'Loading')
                            : i.readyState == 4 || (l.status = 'Unknown')
              ...
              var b = (function (e) {
                function t() {
                  ...
                  ;(n = this),
                    ...
                    (o =
                      !r || (d(r) !== 'object' && typeof r !== 'function')
                        ? p(n)
                        : r)
                  var u = p(p(o))
                  ;(u.isInited = !1),
                  ...
                  (n = [
                    ...
                    },
                    {
                      ...
                      value: function (e) {
                        ...
                        if (o) {
                          this.getNode(t),
                            o.view && c.default.removeClass(o.view, 'vcelm-noc')
